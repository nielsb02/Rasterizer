...
namespace Template
{
    ...
    public class Mesh
    {
        ...
        public void Render(Shader shader, Matrix4 transform, Matrix4 toWorld, Texture texture, Vector3 camera, float diff, float spec, int shi)
        {
            ...
            GL.Uniform3(shader.uniform_Phlong, diff, spec, (float)shi);
            GL.Uniform3(shader.uniform_CameraLocation, camera);
