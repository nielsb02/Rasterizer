...
namespace Template
{
	public class Shader
	{
		...
		public int uniform_Phlong;
		public int uniform_CameraLocation;
		...
		public Shader( String vertexShader, String fragmentShader )
		{
			...
			uniform_Phlong = GL.GetUniformLocation(programID, "Phlong" );
			uniform_CameraLocation = GL.GetUniformLocation(programID, "Camera");
		}
